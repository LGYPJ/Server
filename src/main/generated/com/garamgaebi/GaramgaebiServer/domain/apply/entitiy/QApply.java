...
public class QApply extends EntityPathBase<Apply> {
    ...
    private static final long serialVersionUID = -249688090L;
    ...
    public final com.garamgaebi.GaramgaebiServer.domain.program.entity.QProgram program;

    public final EnumPath<com.garamgaebi.GaramgaebiServer.domain.apply.entitiy.vo.ApplyStatus> status = createEnum("status", com.garamgaebi.GaramgaebiServer.domain.apply.entitiy.vo.ApplyStatus.class);
    ...
    public QApply(Class<? extends Apply> type, PathMetadata metadata, PathInits inits) {
        ...
        this.program = inits.isInitialized("program") ? new com.garamgaebi.GaramgaebiServer.domain.program.entity.QProgram(forProperty("program")) : null;
    }

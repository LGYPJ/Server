...
public class QCareer extends EntityPathBase<Career> {
    ...
    private static final long serialVersionUID = -368127991L;
    ...
    public final EnumPath<com.garamgaebi.GaramgaebiServer.domain.entity.status.member.IsWorking> isWorking = createEnum("isWorking", com.garamgaebi.GaramgaebiServer.domain.entity.status.member.IsWorking.class);

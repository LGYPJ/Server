...
public class QEducation extends EntityPathBase<Education> {
    ...
    private static final long serialVersionUID = -1929195715L;
    ...
    public final EnumPath<com.garamgaebi.GaramgaebiServer.domain.entity.status.member.IsLearning> isLearning = createEnum("isLearning", com.garamgaebi.GaramgaebiServer.domain.entity.status.member.IsLearning.class);
